      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          >
            <img
              src={logo1}
              alt="Luxury Store logo"
              className="h-10 w-10 rounded-xl object-cover ring-1 ring-violet-100"
            />
            <span className="bg-gradient-to-r from-violet-600 via-fuchsia-600 to-pink-500 bg-clip-text text-transparent text-xl sm:text-2xl">
              Luxury Store
            </span>
          </Link>
