...
export default function CollectionCarousel({ products }) {
  ...
  return (
    <div className="relative mt-5 overflow-hidden rounded-2xl border border-white/25 bg-black/20 p-2.5 backdrop-blur sm:p-3">
      ...
      <div className="grid gap-2 sm:grid-cols-[1.15fr_0.85fr]">
        <div className="relative h-40 overflow-hidden rounded-xl bg-white/85 sm:h-48">
          ...
          {sideSlides.map((product) => {
            ...
            return (
              <button
                ...
                className="group relative overflow-hidden rounded-xl border border-white/30 bg-white/85"
              >
                <img
                  src={resolvedImage}
                  alt={product.title}
